angular.module('roleCtrl', ['userService', 'mgcrea.ngStrap'])
  .directive('attachment', function() {
    var link = function(scope, element,
      attrs, controller, transcludeFn) {

      scope.$watch('vm.files', function(newApps, oldApps) {
        if (newApps) {
    ...
    return {
      restrict: 'E',
      templateUrl: 'app/views/pages/attachment.dir.html',
  ...
  .directive('rolepage', function($location, $aside) {
    var link = function(scope, element,
      attrs, controller, transcludeFn) {
